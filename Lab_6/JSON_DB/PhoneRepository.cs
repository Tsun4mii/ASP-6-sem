...
namespace JSON_DB
{
    public sealed class PhoneRepository : IRepository<Phone>
    {
        ...
        public void SaveModel()
        {
            ...
            File.WriteAllText(@"E:\3rd-course\2nd-sem\ASP\Lab_6\JSON_DB\PhonesDB.json", json);
        }

        public void LoadModel()
        {
            Phones = JsonSerializer.Deserialize<List<Phone>>(File.ReadAllText(@"E:\3rd-course\2nd-sem\ASP\Lab_6\JSON_DB\PhonesDB.json"));
        }
